export default {
    changeSectionsTematicUnit(){
        let showDatTematicUnit = document.querySelector("#showDataTematicUnit")
        let addDatTematicUnit = document.querySelector("#addDataTematicUnit")

        addDatTematicUnit.addEventListener("click", (e) =>{
            document.querySelector("#formTematicUnit").style.display = "flex";
            document.querySelector(".showTematicUnit").innerHTML = null;
        })

        showDatTematicUnit.addEventListener("click", async(e) =>{
            let config = {
                method: "GET",
            ...
            let plantilla = `
                            ...
                            `;
                        document.querySelector(".showTematicUnit").innerHTML = plantilla;
                        document.querySelector("#formTematicUnit").style.display = "none";
    ...
    updateInfo(){
        ...
        newFormRoute.addEventListener("submit", async(e) =>{
            ...
            let data = Object.fromEntries(new FormData(e.target));
            data.name_route = data.name_route.toLocaleUpperCase();
            data.description = data.description.toLocaleUpperCase();
